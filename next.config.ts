...
const ContentSecurityPolicy = `
  default-src 'self';
  script-src 'self' 'unsafe-eval' 'unsafe-inline' giscus.app analytics.umami.is cdn.iframe.ly https://platform.twitter.com https://*.twitter.com https://x.com https://*.x.com https://www.instagram.com;
...
const output = process.env.EXPORT ? ('export' as NextConfig['output']) : undefined
